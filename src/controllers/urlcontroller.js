...
const redisClient = redis.createClient(
  16319, //port
  "redis-16319.c10.us-east-1-2.ec2.cloud.redislabs.com",//Ip address
  { no_ready_check: true }
);
redisClient.auth("LpxuQlBSMm7MFYavCb9WaXgPzK7s7NjL", function (err) { //password
  if (err) throw err;
});
...
// Second Get API to redirect from short url to Corresponding Long url
